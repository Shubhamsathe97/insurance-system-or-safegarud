...
public class bikePolicy extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter the Bike Number");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Full Cover - Road helmet", "Stolen - Tracking System", "Repairing - Tire repair kit" }));
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon("C:\\Users\\shubh\\OneDrive\\Desktop\\Insurance Management\\Insurance Management\\Icon 1\\Untitled design (9).png")); // NOI18N
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 80, -1, -1));

        jLabel13.setIcon(new javax.swing.ImageIcon("C:\\Users\\shubh\\OneDrive\\Desktop\\Insurance Management\\Insurance Management\\Icon 1\\Untitled design.jpg")); // NOI18N
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, -10, -1, -1));

        jLabel15.setText("jLabel15");
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 140, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String bikename=jTextField1.getText();
        String bikenumber=jTextField2.getText();
        ...
        try{
            ...
            st.executeUpdate("insert into bike values('"+bikename+"','"+bikenumber+"','"+insurance+"','"+date+"','"+price+"','"+transaction+"','"+returnInsurance+"')");
            JOptionPane .showMessageDialog(null,"Buy Insurance Successfully");
            setVisible(false);
            new bikePolicy().setVisible(true);
        }
        catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bikePolicy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
