...
public class returnInsurancebike extends javax.swing.JFrame {

    /**
     * Creates new form returnBook
     */
    public returnInsurancebike() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon("C:\\Users\\shubh\\OneDrive\\Desktop\\Insurance Management\\Insurance Management\\Icon 1\\Untitled design.jpg")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("select * from bike where name='"+name+"' and email='"+emailid+"'");
            if(rs.next()){
                ...
                setVisible(false);
                new returnInsurancebike().setVisible(true);
            }
        }
        catch(Exception e){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            Connection con=ConnectionProvider.getCon();
            Statement st=con.createStatement();
            st.executeUpdate("update bike set returnInsurance='YES' where name='"+name+"' and email='"+emailid+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(returnInsurancebike.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
